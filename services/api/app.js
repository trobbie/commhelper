...
console.log('COMMHELPER_TEST_ENV:' + process.env.COMMHELPER_ENV);
let service_port;
if (process.env.COMMHELPER_TEST_ENV == 'unit-test') {
  // use different port so as to not interfere with any currently running service
  service_port = 3001;
} else {
  service_port = 3000;
}
